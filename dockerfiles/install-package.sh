...
do
    ...
    case $arg in
        core)
            cd /home/coder/autogoal/autogoal && sudo poetry lock && sudo poetry install
            cd /home/coder/autogoal && pip install -e autogoal
        ;;
        remote)
            cd /home/coder/autogoal/autogoal-remote && sudo poetry lock && sudo poetry install
            cd /home/coder/autogoal && sudo pip install -e autogoal-remote
        ;;
        common)
            cd /home/coder/autogoal/autogoal-contrib/autogoal_contrib && sudo poetry lock && sudo poetry install
            cd /home/coder/autogoal/autogoal-contrib && sudo pip install -e autogoal_contrib
        ;;
        *)
            cd "/home/coder/autogoal/autogoal-contrib/autogoal_$arg" && sudo poetry lock && sudo poetry install
