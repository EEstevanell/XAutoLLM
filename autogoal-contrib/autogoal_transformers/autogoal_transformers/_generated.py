# AUTOGENERATED ON 2025-05-13 19:52:21.318194
...
class TEXT_GEN_Deepseek_Ai_Deepseek_V2_Lite(TextGenerationTransformer):
...
class TEXT_GEN_Deepseek_Ai_Deepseek_R1_Distill_Qwen_15B(TextGenerationTransformer):
...
class TEXT_GEN_Deepseek_Ai_Deepseek_R1_Distill_Qwen_7B(TextGenerationTransformer):
...
class TEXT_GEN_Deepseek_Ai_Deepseek_R1_Distill_Qwen_14B(TextGenerationTransformer):
...
class TEXT_GEN_Deepseek_Ai_Deepseek_R1_Distill_Llama_8B(TextGenerationTransformer):
...
class TEXT_GEN_Microsoft_Phi_35_Mini_Instruct(TextGenerationTransformer):
...
class TEXT_GEN_Microsoft_Phi_4_Mini_Instruct(TextGenerationTransformer):
...
class TEXT_GEN_Microsoft_Phi_4(TextGenerationTransformer):
...
class TEXT_GEN_Microsoft_Phi_4_Reasoning(TextGenerationTransformer):
...
class TEXT_GEN_Mistralai_Mistral_Nemo_Instruct_Fp8_2407(TextGenerationTransformer):
...
class TEXT_GEN_Mistralai_Mistral_Nemo_Base_2407(TextGenerationTransformer):
...
class TEXT_GEN_Meta_Llama_Llama_32_1B(TextGenerationTransformer):
...
class TEXT_GEN_Meta_Llama_Llama_32_1B_Instruct(TextGenerationTransformer):
...
class TEXT_GEN_Meta_Llama_Llama_32_3B(TextGenerationTransformer):
...
class TEXT_GEN_Meta_Llama_Llama_32_3B_Instruct(TextGenerationTransformer):
...
class TEXT_GEN_Meta_Llama_Llama_31_8B(TextGenerationTransformer):
...
class TEXT_GEN_Meta_Llama_Llama_31_8B_Instruct(TextGenerationTransformer):
...
class TEXT_GEN_Meta_Llama_Llama_31_70B(TextGenerationTransformer):
...
class TEXT_GEN_Meta_Llama_Llama_31_70B_Instruct(TextGenerationTransformer):
