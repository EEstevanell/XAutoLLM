#!/usr/bin/env python3
"""
Text classification experiment for the RANLP25 dataset using encoder-only transformer models.
"""
import os
import sys
import logging
...
EXPERIMENT_ID = f"ranlp25_encoders_{int(time.time())}"
...
def execute_experiment():
    ...
    logger.info(f"Found {len(algorithm_registry)} encoder models")
